...
class RotorFeedbackStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RotorFeedbackStamped(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RotorFeedbackStamped(null);
...
RotorFeedbackStamped.Constants = {
  INVALID_TYPE: 0,
  THROTTLE_TYPE: 1,
  SPEED_TYPE: 2,
  THRUST_TYPE: 3,
...
module.exports = RotorFeedbackStamped;
