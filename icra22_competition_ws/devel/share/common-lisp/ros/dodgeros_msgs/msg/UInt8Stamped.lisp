...
(cl:defmethod cl:initialize-instance :after ((m <UInt8Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UInt8Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dodgeros_msgs-msg:<UInt8Stamped> is deprecated: use dodgeros_msgs-msg:UInt8Stamped instead.")))
